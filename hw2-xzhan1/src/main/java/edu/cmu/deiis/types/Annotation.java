...
/** 
 * Updated by JCasGen Fri Oct 10 17:33:18 EDT 2014
...
public class Annotation extends org.apache.uima.jcas.tcas.Annotation {
  ...
  *
  ...
  public String getSentence() {
    if (Annotation_Type.featOkTst && ((Annotation_Type)jcasType).casFeat_Sentence == null)
      jcasType.jcas.throwFeatMissing("Sentence", "edu.cmu.deiis.types.Annotation");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Annotation_Type)jcasType).casFeatCode_Sentence);}
  ...
  public void setSentence(String v) {
    if (Annotation_Type.featOkTst && ((Annotation_Type)jcasType).casFeat_Sentence == null)
      jcasType.jcas.throwFeatMissing("Sentence", "edu.cmu.deiis.types.Annotation");
    jcasType.ll_cas.ll_setStringValue(addr, ((Annotation_Type)jcasType).casFeatCode_Sentence, v);}    
  ...
  public String getId() {
    if (Annotation_Type.featOkTst && ((Annotation_Type)jcasType).casFeat_Id == null)
      jcasType.jcas.throwFeatMissing("Id", "edu.cmu.deiis.types.Annotation");
